...
<head>
    <meta charset="utf-8">
    <title>Contact <?php echo COMPANY_NAME; ?> - Europe and Asia Offices</title>
    <meta name="keywords" content="<?php echo COMPANY_NAME; ?> Europe Office, <?php echo COMPANY_NAME; ?> Asia Office, Contact Information, Office Addresses, Vat Number, Email, Phone">
    <meta name="description" content="Contact <?php echo COMPANY_NAME; ?> through our Europe and Asia offices. Find our office addresses in <?php echo COMPANY_COUNTRY; ?> and Singapore, along with contact details, including email and phone numbers.">
...
<!-- Modal End-->
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url(img/contact.jpg) center center no-repeat; background-size: cover; margin-bottom: 90px;">
            <div class="row py-5">
                ...
                <div class="col-lg-12">                    
                    <div class="blog-item bg-light rounded overflow-hidden">                                
                            <div class="p-4 text-center">
                                <span class="d-inline-flex"><h1 class="mb-0">Submit Your CV here. </h1><a href="#" class="btn btn-primary py-2 px-4 ms-3" data-bs-toggle="modal" data-bs-target="#cvModal">Submit your CV</a></span>
    ...
    <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">LET'S DISCUSS YOUR PROJECT.</h1>
            </div>           
            <div class="row g-5">
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form id="form_query">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <input type="text" class="form-control border-0 bg-light px-4" id="qry_name" placeholder="Your Name" style="height: 55px;">
                            </div>
                            <div class="col-md-6">
                                <input type="email" class="form-control border-0 bg-light px-4" id="qry_mail" placeholder="Your Email" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="text" class="form-control border-0 bg-light px-4" id="qry_subject" placeholder="Subject" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <textarea class="form-control border-0 bg-light px-4 py-3" rows="4" id="qry_msg" placeholder="Message"></textarea>
                            </div>
                            <div class="col-12">
                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    ...
                    src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=<?php echo COMPANY_ADDRESS_LINE1; ?>, 1932 Zaventem, <?php echo COMPANY_COUNTRY; ?>&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5 mb-5">
            <div class="row g-5 mb-5">
                <div class="col-lg-6">                    
                    <div class="blog-item bg-light rounded overflow-hidden">                                
                        <div class="p-4">
                            ...
                            <h4 class="mb-3 py-3">Visit our Europe Office</h4>
                            <p class="mt-3 mb-4" style="color: #061429;"><?php echo COMPANY_NAME_FULL; ?> <br/>
                                                                        <?php echo COMPANY_ADDRESS_LINE1; ?> <br/>
                                                                        <?php echo COMPANY_POSTAL_CODE . ' ' . COMPANY_CITY; ?> <?php echo COMPANY_COUNTRY; ?>.<br/>
                                                                        Vat: <?php echo COMPANY_VAT; ?></p>
                            <p class="mt-3 mb-4" style="color: #061429;"><i class="fa fa-envelope-open"></i> admin@proconsultancy.be</p>
                            <p class="mt-3 mb-4" style="color: #061429;"><i class="fa fa-phone-alt"></i> +32-472849033</p>
                ...
                <div class="col-lg-6">                    
                    <div class="blog-item bg-light rounded overflow-hidden">                                
                        <div class="p-4">
                            ...
                            <h4 class="mb-3 py-3">Visit our 2nd Europe Office</h4>
                            <p class="mt-3 mb-4" style="color: #061429;">Avenue de la charmille 14 bte 2<br/>
                ...
                <!--                <i class="fa fa-map-marker-alt text-white"></i>-->
                <!--            </div>-->
                <!--            <h4 class="mb-3 py-3">Visit our Asia Office</h4>-->
                <!--            <p class="mt-3 mb-4" style="color: #061429;"><?php echo COMPANY_NAME; ?> Pte. Ltd.<br/>-->
