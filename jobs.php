...
<head>
    <meta charset="utf-8">
    <title>Job Opportunities at <?php echo COMPANY_NAME; ?> - Current Openings</title>
    <meta name="keywords" content="Job Opportunities, Current Openings, Career at <?php echo COMPANY_NAME; ?>, Employment, Job Listings">
    <meta name="description" content="Explore job opportunities at <?php echo COMPANY_NAME; ?>. View our current openings and join our team for a rewarding career. Find the perfect employment opportunity that suits your skills and aspirations.">
...
<body>
    ...
    <!-- Modal End-->
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url(img/job.png) center center no-repeat; background-size: cover; margin-bottom: 90px;">
            <div class="row py-5">
    ...
    <!-- Blog Start -->
    <div class="container-fluid wow slideInDown" data-wow-delay="0.1s">
        <div class="container">
            <div class="row g-5">
                <!-- Blog list Start -->
                ...
                <div class="col-lg-8">
                    <div class="section-title section-title-sm position-relative pb-3 mb-4">
                        <h3 class="mb-0">Current Openning</h3>
                    </div>
                    <div class="row g-5">                        
                        <div class="row" id="jobspost-container">
                        </div> 
                        <div class="col-12 wow slideInUp" data-wow-delay="0.1s" id="pagination">  
                ...
                <div class="col-lg-4">                    
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start" id="jobs-banner-container">
